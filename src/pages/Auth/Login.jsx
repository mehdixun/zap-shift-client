...
const Login = () => {
    ...
    return (
        ...
        <fieldset className="fieldset">
          ...
          <h3 className='text-center text-md font-semibold mt-2'>Don't Have An Account? Please <Link className='text-green-500 underline font-bold' to='/register'>Register Now</Link></h3>
        </fieldset>
        </form>
    );
};
